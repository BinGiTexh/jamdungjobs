...
const HomePage = () => {
  ...
  return (
    <>
      <Seo title="Jamaica Job Board – Find Jobs & Hire Talent" description="Discover the latest job opportunities across Jamaica or post vacancies for top local talent on JamDung Jobs." />
      <Box
        sx={{
          minHeight: "100vh",
          display: "flex",
